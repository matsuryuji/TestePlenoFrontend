...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-between h-full">
      <div className="flex flex-col">
        ...
        <div className="flex flex-row mt-4">
          ...
          <div className="flex flex-col overflow-x-hidden ">
            ...
            <div className="flex flex-row bg-dark h-[220px] mr-5 rounded-xl shadow-sm justify-between overflow-y-hidden">
      ...
      <div className="flex flex-row bg-dark-gray w-full h-[45px] items-center justify-center">
